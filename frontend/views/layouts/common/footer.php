            ...
            <div class="col-md-4">
                <div class="col">
                    ...
                    <ul class="footer-links info social-networks">
                        <li>
                            <a href="/">
                                <svg width="20px" height="20px" viewBox="0 0 20 20" fill="currentColor" class="icon" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <li>
                            <a href="/">
                                <svg width="20px" height="20px" viewBox="0 0 32 32" fill="currentColor" class="icon" xmlns="http://www.w3.org/2000/svg">
